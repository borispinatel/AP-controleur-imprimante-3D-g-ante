...
#define STRING_CONFIG_H_AUTHOR "(lecomte,01)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 200, 120, 133, 500 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_LAYER_HEIGHT   0.7  // (mm) Default layer height for the G26 Mesh Validation Tool.
